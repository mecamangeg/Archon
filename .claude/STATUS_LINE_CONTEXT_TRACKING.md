# Status Line Context Window Tracking

## Overview

Your Claude Code status line now displays **accurate real-time context window usage** in the format:
```
📊 XX.Xk/200k (XX%)
```
...
### Status Line Format
```
[Model] │ 📊 79.6k/200k (40%) │ 📁 directory │ ⎇ git-branch │ 🎤 Butler: State
```
...
### Example
```
[Sonnet] │ 📊 79.6k/200k (40%) │ 📁 archon │ ⎇ main │ 💭 Butler: Processing
```
...
✅ **Accurate tracking** - Uses real API token counts
...
Your status line now shows exactly what you wanted: **`XX.Xk/200k (XX%)`** where XX is the **actual consumed context** in your 200k window session! 🎉
